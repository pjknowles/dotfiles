...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/pjknowles/dotfiles/master/remote-install.sh`"
```
...
```bash
git clone https://github.com/pjknowles/dotfiles.git ~/.dotfiles
```
